...
[![Typing SVG](https://readme-typing-svg.herokuapp.com?font=Fira+Code&weight=600&size=28&duration=3500&pause=900&color=00BFBF&center=true&vCenter=true&width=1000&lines=Olá%2C+eu+sou+Emannuel+Morais;Desenvolvedor+Full+Stack+Pleno+na+Accenture;Java+%7C+Spring+Boot+%7C+Node.js+%7C+Angular+%7C+React;Construindo+aplicações+escaláveis+e+confiáveis;Bem-vindo+ao+meu+GitHub!)](https://git.io/typing-svg)
...
[![Portfólio](https://img.shields.io/badge/Portf%C3%B3lio-00bfbf?style=for-the-badge&logo=vercel&logoColor=0D1117)](https://devemannuelmorais.github.io/portfolio/)
...
Sou **Desenvolvedor Full Stack Pleno**, formado em **Análise e Desenvolvimento de Sistemas**, com experiência em projetos dos setores **bancário** e **público**.

Atualmente atuo na **Accenture**, alocado em cliente financeiro, trabalhando no desenvolvimento, manutenção e evolução de **sistemas críticos, APIs, microsserviços, integrações e aplicações web**.

Tenho experiência tanto com **sistemas legados** quanto com **tecnologias modernas**, contribuindo para a sustentação, modernização e evolução de aplicações de alta complexidade.

- 🔹 Desenvolvedor Full Stack com maior foco em **Back-End**
- 🔹 Experiência com **Java, Spring Boot, Java EE, Node.js, NestJS, Express, Angular, React e Ruby on Rails**
- 🔹 Desenvolvimento e manutenção de **APIs REST, integrações SOAP e microsserviços**
- 🔹 Experiência com **PostgreSQL, Oracle, MySQL, MongoDB e Apache Kafka**
- 🔹 Atuação com **CI/CD, Docker, Git, GitHub Actions, GitLab, Jenkins e Argo**
- 🔹 Experiência com testes automatizados usando **Jest, JUnit, Mockito e RSpec**
- 🔹 Foco em qualidade de software, escalabilidade, colaboração, boas práticas e melhoria contínua
...
![Android Native](https://img.shields.io/badge/Android_Nativo-0D1117?style=for-the-badge&logo=android&logoColor=00bfbf)
...
### DevOps, Ferramentas e Plataformas
...
Legado         Struts, Servlets, EJB, JSP, MyBatis, Hibernate
Front-End      Angular, React, TypeScript, JavaScript, Bootstrap, Semantic UI
Mobile         React Native, Android Nativo, Flutter
Banco de Dados PostgreSQL, Oracle, MySQL, MongoDB
Arquitetura    APIs REST, SOAP, Microsserviços, Arquitetura orientada a eventos
DevOps         Git, Docker, GitHub Actions, GitLab, Jenkins, Argo, CI/CD, SVN
Mensageria     Apache Kafka
Testes         Jest, JUnit, Mockito, RSpec
Relatórios     JasperReports, Pentaho
...
[![GitHub Streak](https://streak-stats.demolab.com?user=DevEmannuelMorais&theme=github-dark-blue&hide_border=true&border_radius=6&date_format=j%20M%5B%20Y%5D&card_width=900)](https://git.io/streak-stats)
...
[![Seguidores](https://img.shields.io/github/followers/DevEmannuelMorais?style=for-the-badge&logo=github&label=Seguidores&color=00bfbf&labelColor=0d1117)](https://github.com/DevEmannuelMorais?tab=followers)
[![Estrelas](https://img.shields.io/github/stars/DevEmannuelMorais?style=for-the-badge&logo=github&label=Estrelas&color=00bfbf&labelColor=0d1117)](https://github.com/DevEmannuelMorais?tab=repositories)
